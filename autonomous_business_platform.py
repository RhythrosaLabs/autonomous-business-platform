...
def get_tab_renderer(tab_name: str):
    ...
    tab_renderers = {
        "🏠 Dashboard": ('abp_dashboard', 'render_dashboard_tab'),
        "⚡ Shortcuts": ('abp_shortcuts', 'render_shortcuts_tab'),
        "🤖 Task Queue": ('abp_task_queue', 'render_task_queue_tab'),
        "🔄 Job Monitor": ('abp_advanced_job_monitor', 'render_advanced_job_monitor_tab'),
        "📦 Product Studio": ('abp_products', 'render_product_studio_tab'),
        "💾 Digital Products": ('abp_digital_products', 'render_digital_products_tab'),
        "🎯 Campaign Creator": ('abp_campaigns', 'render_campaign_creator_tab'),
        "📝 Content Generator": ('abp_content', 'render_content_generator_tab'),
        "🎬 Video Producer": ('abp_video', 'render_video_producer_tab'),
        "🎮 Playground": ('abp_playground', 'render_playground_tab'),
        "🔧 Workflows": ('abp_custom_workflows', 'render_custom_workflows_tab'),
        "📅 Calendar": ('abp_calendar', 'render_calendar_tab'),
        "📓 Journal": ('abp_journal', 'render_journal_tab'),
        "🔍 Contact Finder": ('abp_contacts', 'render_contact_finder_tab'),
        "👥 Customers": ('abp_customers', 'render_customers_tab'),
        "📊 Analytics": ('abp_analytics', 'render_analytics_tab'),
        "🎨 Brand Templates": ('abp_brand_templates', 'render_brand_templates_tab'),
        "💌 Email Outreach": ('abp_email_outreach', 'render_email_outreach_tab'),
        "🎵 Music Platforms": ('abp_music_platforms_pro', 'render_music_platforms_tab'),
        "📁 File Library": ('abp_files', 'render_file_library_tab'),
        "🌐 Browser-Use": ('abp_browser_use', 'render_browser_use_tab'),
    }
...
try:
    ...
    def render_performance_settings():
        st.info("⚙️ Performance settings module not available. Install 'performance_optimizations' for advanced options.")
...
try:
    ...
    def render_full_usage_dashboard():
        st.info("📊 Usage dashboard requires 'platform_integrations' module for API tracking and analytics.")
